...
?>
    <tr>
	  ...
	  <td align="center"><?php echo $this->_var['type']['type_money']; ?></td>
	  <td align="center"><?php echo $this->_var['type']['type_money_count']; ?></td>
	  <td align="center"><?php echo $this->_var['type']['type_money_all']; ?></td>
      <td align="center">
	    <a href="takegoods.php?act=send&amp;id=<?php echo $this->_var['type']['type_id']; ?>&amp;send_by=<?php echo $this->_var['type']['send_type']; ?>"><?php echo $this->_var['lang']['send']; ?></a> |
        <a href="takegoods.php?act=tg_list&amp;tg_type=<?php echo $this->_var['type']['type_id']; ?>&amp;is_used=-1"><?php echo $this->_var['lang']['view']; ?></a> |
        <a href="takegoods.php?act=edit&amp;type_id=<?php echo $this->_var['type']['type_id']; ?>"><?php echo $this->_var['lang']['edit']; ?></a> |
		<a href="takegoods.php?act=add_goods&amp;type_id=<?php echo $this->_var['type']['type_id']; ?>"><?php echo $this->_var['lang']['addgoods']; ?></a> |
