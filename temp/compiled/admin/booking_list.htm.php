...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      ...
      <th width="40%"><a href="javascript:listTable.sort('goods_name'); "><?php echo $this->_var['lang']['goods_name']; ?></a><?php echo $this->_var['sort_goods_name']; ?></th>
...
?>
    <tr>
      <td align="center"><?php echo $this->_var['booking']['rec_id']; ?></td>
      ...
      <td align="center"><?php echo $this->_var['booking']['goods_number']; ?></td>
      <td align="center"><?php echo $this->_var['booking']['booking_time']; ?></td>
	  <td align="center"><?php echo $this->_var['notice_status'][$this->_var['booking']['is_dispose']]; ?></td>
